<?php 
    ...
    $queryArtist = "SELECT * from artists, art WHERE artists.artist_id = art.artist_id ORDER BY art_name";
...
<html>
	...
	<link rel = "icon" type = "image/png" sizes = "128x128" href = "assets/default/favicon128x128.png"> <!-- ICONNNN UGHHHNNG D: -->
        <title>
            Artists I Know : View All By Name
        </title>
    </head>
    <body>
        <div id = "container">
            ...
            <div id = "sorts">
                <h2>Sort by:</h2>
                <form action = "viewAllArt.php" id = "order">
                    <input type = "submit" value = "Artist">
                </form>
                <form action = "viewArtByDate.php" id = "order2">
                    <input type = "submit" value = "Date">
                </form>
            </div>
            <div id = "indexBody">
                <h1>All Art By Name</h1>
